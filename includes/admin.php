...
function wp_selectize_enqueue_assets() {
    ...
    wp_enqueue_style( 'selectize-bootstrap3',     $url . 'assets/css/selectize.bootstrap3.css', array(),          $ver );
    wp_enqueue_style( 'selectize-overrides',     $url . 'assets/css/overrides.css', array(),          $ver );
